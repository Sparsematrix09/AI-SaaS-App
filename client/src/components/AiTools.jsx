...
const AiTools = () => {
  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 my-24 text-white'>
      {/* Section Header */}
      ...
      <div className='flex flex-wrap mt-10 justify-center'>
        {AiToolsData.map((tool, index) => (
          <div 
            key={index} 
            className='p-8 m-4 max-w-xs rounded-lg bg-gray-800 shadow-lg border border-gray-700 hover:-translate-y-1 transition-all duration-300 cursor-pointer'
